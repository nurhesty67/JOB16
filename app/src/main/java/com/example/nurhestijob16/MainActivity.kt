package com.example.nurhestijob16
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val biodata = arrayOf("Nur Hesti Mugi Rahayu", "XI PPLG 2", "3023")
        ...
        btn2.setOnClickListener {
            ...
            val dialoglayout = inflater.inflate(R.layout.activity_activitydialog, null)
